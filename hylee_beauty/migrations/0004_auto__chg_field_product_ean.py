...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hylee_beauty_product', 'ean', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Product.ean'
        db.alter_column(u'hylee_beauty_product', 'ean', self.gf('django.db.models.fields.IntegerField')())
